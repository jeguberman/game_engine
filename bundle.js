...
var core = exports.core = function core() {
  ...
  if (options.fullFunc) {
    throw _exceptions.OptionsException.call(undefined)(options, "can not override function wrapper fullFunc");
  }
...
var _objData = __webpack_require__(118);
